...
| 情况                                                           | 公式                                                                                |
| -------------------------------------------------------------- | ----------------------------------------------------------------------------------- |
| 组可区分（组有标签，每组人数已确定。例如(甲，乙，丙)=(4,1,1)） | $\displaystyle \frac{M!}{\prod _{i=1}^n m_i!}$                                      |
| 组可区分（组有标签，仅给型谱，例如甲乙丙三组按照(4,1,1)分配 ） | $\displaystyle \frac{M!}{\prod _{i=1}^n m_i!} \cdot \frac{n!}{\prod _{j=1}^k r_j!}$ |
| 组不可区分（无标签，仅看成员集合）                             | $\displaystyle \frac{M!}{\prod _{i=1}^n m_i!} \cdot \frac{1}{\prod _{j=1}^k r_j!}$  |
...
> | 情况                          | 计算                                                                                            |
> | ----------------------------- | --------------------------------------------------------------------------------------------------- |
> | 组可区分（每组人数已确定） | $\displaystyle \frac{12!}{3! \times 3! \times 2! \times 2! \times 2!}$                              |
> | 组不可区分                    | $\displaystyle \frac{12!}{3! \times 3! \times 2! \times 2! \times 2!} \cdot \frac{1}{2! \times 3!}$ |

> [!WARNING]
> 6 人分为甲乙丙三个小组，大小分别为 4, 1, 1
> | 情况                          | 计算                                                                                            |
> | ----------------------------- | --------------------------------------------------------------------------------------------------- |
> | (甲,乙,丙)=(4,1,1) | $\displaystyle \frac{6!}{4!} = 30$                              |
> |     甲乙丙每组人数不确定           | $\displaystyle \frac{6!}{4!} \cdot \frac{3!}{2!}=90$ |
